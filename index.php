...
<html><head>
    ...
    <base href="http://localhost/TA-SistemPakar-Juan/">
	<link rel="icon" href="gambar/admin/favicon.ico">
  ...
  <body id="pakarayam" class="hold-transition skin-purple-light sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="./" class="logo">
          <span class="logo-mini"><img src="aset\LogoLab-Circle.png" width="25" height="25"><b><i aria-hidden="true"></i>SP</b></span>
          <span class="logo-lg"><img src="aset\LogoLab-Circle.png" width="25" height="25"><b><i aria-hidden="true"></i>Sistem Pakar</b></span>
        </a>
        <!-- Header Navbar -->
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Supervisior LAB ICT</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
      ...
      <footer class="main-footer">
        ...
        <strong><div class="cinta">© 2022 <i class="fa fa-heart pulse"></i> by <a href="http://labict.budiluhur.ac.id" target="_blank">LAB ICT 2018</a></div></strong>
      </footer>
